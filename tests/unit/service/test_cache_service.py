...
class TestCacheService:
    ...
    async def test_successfully_get_key_value(self, cache_service, key_value, settings, httpx_mock):
    ...
    async def test_successfully_put_key_value(self, cache_service, key_value, settings, httpx_mock):
        httpx_mock.add_response(
